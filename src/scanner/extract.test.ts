...
describe('extractImports', () => {
    it('should extract import declarations', () => {
        const imports = 'src/fixtures/extract/imports.ts';
    ...
    it('should extract export declarations', () => {
        const exports = 'src/fixtures/extract/exports.ts';
    ...
    it('should return both imports and exports', () => {
        const importsExports = 'src/fixtures/extract/imports-exports.ts';
    ...
    it('should return empty array when file has no imports', () => {
        const noImportsAndExports = 'src/fixtures/extract/no-imports-and-exports.ts';
